...
-- =====================================================
-- NUEVAS TABLAS PARA FUNCIONALIDADES DE CLIENTES
...
-- Historial de visitas (cuando un cliente ve un perfil)
...
-- Suscripciones a ciudades (para notificaciones)
...
create table if not exists public.notificaciones (
  ...
  tipo       text not null, -- 'nuevo_barbero_ciudad' | 'favorito_actualizo'
